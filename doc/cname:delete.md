...
The delete command is used to delete Infoblox CNAME records.
To delete a single CNAME record, a single hostname may
...
- ibapi cname delete rb4.rice.edu somewhere.com
    ...
    Delete the CNAME record with hostname "rb4.rice.edu" and target "somewhere.com".
