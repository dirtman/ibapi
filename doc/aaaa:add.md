...
The add command is used to create Infoblox AAAA records.
To create a single AAAA record, a single hostname and IP address can be provided as
...
- -f &lt;filename>, --Filename=&lt;filename>:
    ...
    Specify a filename containing a list of AAAA records to create.
...
- -C, --Check:
    ...
    such as an Host record and AAAA record with the same name and/or IP address.
    Default: false.
...
- ibapi aaaa add rb4.rice.edu c00:1234:5678:9abc::21
    ...
    Create a new AAAA record with hostname "rb4.rice.edu" and IP address "c00:1234:5678:9abc::21".

- ibapi aaaa add -V external -f /tmp/hosts

    Create an AAAA record in the "external" view for each hostname/IP pair specified in the file "/tmp/hosts". 
