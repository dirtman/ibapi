...
- -C, --Check:
    ...
    such as an AAAA record and Host record with the same hostname and/or IP address.
    Default: false.
...
- ibapi aaaa update rb4.rice.edu c00:1234:5678:9abc::21 -i c00:1234:5678:9abc::22

    Update the "rb4.rice.edu/c00:1234:5678:9abc::21" AAAA record, changing the IP address 
    to "c00:1234:5678:9abc::22".
