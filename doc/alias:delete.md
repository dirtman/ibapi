...
The delete command is used to delete Infoblox Alias records.
To delete a single Alias record, a single hostname and optionally a target
...
- ibapi alias delete rb4.rice.edu somewhere.com
    ...
    Delete the Alias record with hostname "rb4.rice.edu" and A record target "somewhere.com".
