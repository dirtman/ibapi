...
To fetch a single AAAA record, a single hostname and/or IP address may be provided as
...
- -f &lt;filename>, --filename=&lt;filename>:
    ...
    Specify a filename containing a list of records to get.
...
- ibapi aaaa get -F name\~=mx -V external
    ...
    Fetch each AAAA record (in the external DNS view) whose name matches "mx".

- ibapi aaaa get -F ipv6addr\~=c00:1234:5678:9abc.

    Fetch each AAAA record (in any DNS view) whose IP address matches "c00:1234:5678:9abc.".
...
- ibapi aaaa get rb4.rice.edu c00:1234:5678:9abc::21
    ...
    Fetch each AAAA record with hostname "rb4.rice.edu" and IP address "c00:1234:5678:9abc::21".
