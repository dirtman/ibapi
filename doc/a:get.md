...
To fetch a single A record, a single hostname and/or IP address may be provided as
...
- ibapi a get -F ipv4addr\~=128.42.201.
    ...
    Fetch each A record (in any DNS view) whose IP address matches "128.42.201.".
