...
The delete command is used to delete Infoblox AAAA records.
To delete a single AAAA record, a single hostname and optionally an IP address may
be provided as command line arguments.
Alternatively, a list of records to delete can be specified in a file (see --filename).

If an IP address is specified, the AAAA record to delete must contain that IP address, else
no address will be deleted.  If no IP address is specified, the AAAA record is deleted
...
- -f &lt;filename>, --filename=&lt;filename>:
    ...
    Specify a filename containing a list of AAAA records to delete.
...
- ibapi aaaa delete rb4.rice.edu c00:1234:5678:9abc::21
    ...
    Delete the AAAA record with hostname "rb4.rice.edu" and IP address "c00:1234:5678:9abc::21".
