...
ibapi is a command-line client for adding, retrieving, updating and
deleting a few of the most basic Infoblox records via the Infoblox WAPI.
Currently supported record types are A, PTR, CNAME, Alias and Host.
...
- ibapi
    ...
    host|a|ptr|cname|alias|url add|get|update|delete &lt;options/args>
