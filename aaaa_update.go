...
func upateAAAA(invokedAs []string) error {
	...
	if name != "" {
		...
		if conflict, err = checkConflict(f, true, check, check, true, true, "AAAA"); err != nil {
